    ...
    try:
        if item_0 is not None:
            ...
            if (
                    ...
                    and item_0.offers.listings
                    and item_0.offers.listings[0]
                    and item_0.offers.listings[0].price
                    and item_0.offers.listings[0].price.savings
                ):
        ...
        res_items.append(it_parsed)
            ...
            # You can also log the error or handle it in other ways if needed
